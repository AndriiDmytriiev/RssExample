...
namespace RssExample.Controllers
{
    public class HomeController : Controller
    {
        ...
        XmlReader reader = XmlReader.Create("https://www.globenewswire.com/RssFeed/subjectcode/1-Advisory/feedTitle/GlobeNewswire%20-%20Advisory");
        ...
        public ActionResult Index(string feed)
        {
            ...
            try
            {
...

                {
                    ...
                    rssXmlDoc.Load("https://www.globenewswire.com/RssFeed/subjectcode/1-Advisory/feedTitle/GlobeNewswire%20-%20Advisory");
